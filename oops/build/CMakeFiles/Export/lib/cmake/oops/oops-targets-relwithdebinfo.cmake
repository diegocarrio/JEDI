...
# Import target "l95_ens_variance.x" for configuration "RelWithDebInfo"
set_property(TARGET l95_ens_variance.x APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(l95_ens_variance.x PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/l95_ens_variance.x"
  )

list(APPEND _IMPORT_CHECK_TARGETS l95_ens_variance.x )
list(APPEND _IMPORT_CHECK_FILES_FOR_l95_ens_variance.x "${_IMPORT_PREFIX}/bin/l95_ens_variance.x" )
...
# Import target "qg_ens_variance.x" for configuration "RelWithDebInfo"
set_property(TARGET qg_ens_variance.x APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(qg_ens_variance.x PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/qg_ens_variance.x"
  )

list(APPEND _IMPORT_CHECK_TARGETS qg_ens_variance.x )
list(APPEND _IMPORT_CHECK_FILES_FOR_qg_ens_variance.x "${_IMPORT_PREFIX}/bin/qg_ens_variance.x" )
...
# Import target "qg_rtpp.x" for configuration "RelWithDebInfo"
set_property(TARGET qg_rtpp.x APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(qg_rtpp.x PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/qg_rtpp.x"
  )

list(APPEND _IMPORT_CHECK_TARGETS qg_rtpp.x )
list(APPEND _IMPORT_CHECK_FILES_FOR_qg_rtpp.x "${_IMPORT_PREFIX}/bin/qg_rtpp.x" )

# Import target "qg_rtps.x" for configuration "RelWithDebInfo"
set_property(TARGET qg_rtps.x APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(qg_rtps.x PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/qg_rtps.x"
  )

list(APPEND _IMPORT_CHECK_TARGETS qg_rtps.x )
list(APPEND _IMPORT_CHECK_FILES_FOR_qg_rtps.x "${_IMPORT_PREFIX}/bin/qg_rtps.x" )

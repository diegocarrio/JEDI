...
### computed paths
set_and_check(oops_CMAKE_DIR "${PACKAGE_PREFIX_DIR}/lib/cmake/oops")
...
### export version info
set(oops_VERSION           "1.10.0")
set(oops_GIT_SHA1          "c8b0f6111bed4c1968cede395f10f279ace59292")
set(oops_GIT_SHA1_SHORT    "c8b0f61")
...
set(oops_IS_BUILD_DIR_EXPORT OFF)
if(DEFINED ECBUILD_2_COMPAT AND ECBUILD_2_COMPAT)
...
if(OFF)
    set_and_check(oops_BINDIR "/home/nonroot/shared/oops_updated/oops/build/bin")
else()
